...
namespace AsyncRedisDocuments
{
    ...
    {
        public static RedisQuery<TDocument> Where<TDocument>(this RedisQuery<TDocument> query, Expression<Func<TDocument, bool>> expression) where TDocument : IAsyncDocument
        {
